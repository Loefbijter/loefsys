    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, storage=loefsys.users.models.user.OverwriteStorage(), upload_to=loefsys.users.models.user.User.user_picture_upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=40, unique=True, verbose_name='Skippership')),
            ],
        ),
        migrations.CreateModel(
            name='MemberDetails',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('since', models.DateField(default=datetime.date.today, help_text='The date the user obtained the skippership.', verbose_name='Skippership since')),
                ('given_by', models.ManyToManyField(help_text='The skippers that have authorized the skippership.', related_name='authorized_skippers', related_query_name='authorized_skipper', to=settings.AUTH_USER_MODEL, verbose_name='Skippers authorized')),
                ('skippership', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='loefusers.skippership')),
        ...
        migrations.AddField(
            ...
            name='skippers',
            field=models.ManyToManyField(help_text='The skippers that have this skippership.', related_name='skippers', related_query_name='skipper', through='loefusers.UserSkippership', to=settings.AUTH_USER_MODEL, verbose_name='Skippers'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            model_name='userskippership',
            constraint=models.UniqueConstraint(fields=('user', 'skippership'), name='unique_skippership'),
        ),
    ]
