...
import loefsys.members.models.user
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(blank=True, null=True, storage=loefsys.members.models.user.OverwriteStorage(), upload_to=loefsys.members.models.user.User.user_picture_upload_path)),
                ('gender', models.PositiveSmallIntegerField(choices=[(0, 'Other'), (1, 'Prefer not to say'), (2, 'Male'), (3, 'Female')], default=1, verbose_name='Gender')),
                ('birthday', models.DateField(blank=True, null=True, verbose_name='Birthday')),
                ('show_birthday', models.BooleanField(default=False, verbose_name='Display birthday')),
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region=None)),
                ('note', models.TextField(blank=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('address', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.address')),
            ],
            options={
                'verbose_name': 'user',
            ...
            managers=[
                ('objects', loefsys.members.models.user.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Membership',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='study_registration', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
